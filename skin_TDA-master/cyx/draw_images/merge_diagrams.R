...
"D-051-1"
filename <- "cyx/output_txt/3_0_20_90_3.txt"
...
D_zero1[, 6] <- rep("2-0",nrow(D_zero1))
...
D_one1[, 6] <- rep("2-0",nrow(D_one1))
colnames(D_one1)<- c("dimension", "Death","Birth", "midlife","lifetime", "ID") 

"D-022-1"
filename2 <- "cyx/output_txt/3_6_20_90_3_0.txt"
...
D_zero2[, 6] <- rep("2-4",nrow(D_zero2))
...
png(filename = "merged_diagrams_1dim.png",width = 4096,height = 2160,res = 300)
g2
dev.off()
...
png(filename = "merged_diagrams_0dim.png",width = 4096,height = 2160,res = 300)
g2
dev.off()