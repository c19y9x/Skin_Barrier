...
# f = load_image("My_image/group_tape_stripping_numbers/3_20_0/3_0_20_0.jpg")
...
for i,image_path1 in enumerate(images_path1):
    ...
    for image_path2 in images_path2:
        ...
        features_mean.append(float(tewl_list[image_path2]))
        img_feature_list.append(features_mean)
        img_name_list.append(image_path2)
        # range
        # features_range = features_range.tolist()
        # features_range.append(float(tewl_list[image_path2]))
        # img_feature_list.append(features_range)
        # img_name_list.append(image_path2)
    if i == 0:
        labels_mean.append("TEWL")
        colunms.append(labels_mean)
        # labels_range.append("TEWL")
        # colunms.append(labels_range)
    
output_excel = "Result/xls/glcm_features_mean.xls"
# output_excel = "Result/xls/glcm_features_range.xls"
